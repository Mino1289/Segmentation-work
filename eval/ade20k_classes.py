"""ADE20K SceneParse150 class names (indices 0–149)."""

from __future__ import annotations

# Source: MIT SceneParse150 objectInfo150.txt (Idx 1–150 → model labels 0–149)
_RAW_NAMES = """
wall
building, edifice
sky
...
CLASS_NAMES = [line.split(",")[0].strip() for line in _RAW_NAMES]
